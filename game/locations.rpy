...
# Simple events for the actions
    ...
    $ prices = {'arcade': 7000, 'arcade_both': 14000, 'movies': 15000, 'movies_student': 7500, 'movies_both': 22500, 'gym': 1000, 'swimminghall': 3000, "bar_cheap": 7000, "bar_medium": 9000, "bar_expensive": 12000, "parlor_cheap": 6000, "parlor_medium": 12000, "parlor_expensive": 24000, "mall_cheap": 3000, "mall_medium": 8000, "mall_expensive": 24000, "bowling": 1000, "restaurant_cheap": 12000, "restaurant_medium": 24000, "restaurant_expensive": 48000}
    $ fitness_bonuses = {'swimminghall': 7, 'runningtrack': 5, 'gym': 6}
    $ stress_modifiers = {'movies': -2, 'arcade': -1, 'bar_drink': -1, 'bar_nodrink': 0, 'library': 0, 'work': 2, 'restaurant': -1, 'mall_expensive': -3, 'mall_medium': -2, 'mall_cheap': -1, 'clean': -1, 'bowling': -1, 'swimminghall': 0, 'gym': 0, 'runningtrack': 0, 'business': 0, 'parlor_broken_up': 0, 'parlor': -2, 'DFO': -4, 'ignore_calls': 1, 'breakup': 3, 'unreality': 2}
...
label .main_hub:
    ...
    ("Couldn't you let me see some places, just this once?", "key_transition2")], ("On second thought, I'll just leave you to your work.", "leave")) from _call_HubMenu
    return
...
label .who:
    ...
    ("You said you didn't like to work here?", "who_Klein_recap")], ("I had some more general questions...", "main_hub_transition")) from _call_HubMenu_1
    return
...
label .what:
    ...
    ("Sorry, I forgot why you're still working on this?", "what_expansion_recap")], ("I had some more general questions...", "main_hub_transition")) from _call_HubMenu_2
    return
...
label .why:
    ...
    ("Can't you sue them or something?", "why_legal_recap")], ("I had some more general questions...", "main_hub_transition")) from _call_HubMenu_3
    return
...
label .move:
    ...
    ("I'd really like to clean this room.", "move_quick_recap")], ("I had some other questions...", "main_hub_transition")) from _call_HubMenu_4
    return
